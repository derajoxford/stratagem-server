...
import { MarketListing, Nation, Resource } from "@/api/entities";
import { ResourceTransaction } from "@/api/entities"; // NEW import
import { GameState } from "@/api/entities"; // NEW import (assuming GameState is a separate entity)

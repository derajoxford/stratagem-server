...
import { User, Nation, Military, Resource, City, GameConfig, War, MarketListing, BuyOrder, Message, AllianceApplication, AllianceInvitation, CeasefireProposal, BattleLog, Alliance, Treaty, AllianceTransaction, MergeProposal } from "@/entities/all";

...
import { Nation, GameState, FinancialTransaction, City, Resource } from '@/entities/all'; // Added Resource
import { ResourceTransaction } from "@/entities/ResourceTransaction"; // Added ResourceTransaction
